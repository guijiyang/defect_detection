...
import sys
sys.path.insert(
    0, '/home/guijiyang/Code/python/torch/metallic_Surface_detect.pytorch')
try:
...
# %%
class_df = pd.read_csv('csv/class_IoU.csv')
...
color_list = [(0.9, 0.9, 0.0), (0.0, 0.8, 0.0),
...
with torch.no_grad():
    ...
    for idx in class_IoU.index[-10:]:
        ...
        orignal_image = cv2.imread(os.path.join(
            data_dir, 'train_images', image_id))
